            ...
            var e, f = this.each(function() {
                ...
                if (b.is("select")) {
                    ...
                    if (f) {
                        ...
                        i.template = a.extend({}, k.DEFAULTS.template, a.fn.selectpicker.defaults ? a.fn.selectpicker.defaults.template : {}, b.data().template, g.template),
                ...
                return this.$element.find("option").each(function(b) {
                    ...
                    !f.hasClass("bs-title-option")) {
                        var k = this.className || ""
                          ...
                          , s = r && q[0].disabled
                          , t = this.disabled || s;
                        if ("" !== p && t && (p = "<span>" + p + "</span>"),
                        c.options.hideDisabled && (t && !r || s))
                            return void g--;
                        if (f.data("content") || (m = p + '<span class="text">' + m + o + "</span>"),
                        r && f.data("divider") !== !0) {
            ...
            liveSearchListener: function() {
                ...
                this.$searchbox.on("input propertychange", function() {
                    ...
                    c.$searchbox.val()) {
                        ...
                        if (e = c.options.liveSearchNormalize ? f.find("a").not(":a" + c._searchStyle() + '("' + b(c.$searchbox.val()) + '")') : f.find("a").not(":" + c._searchStyle() + '("' + c.$searchbox.val() + '")'),
                        e.length === f.length)
                            d.html(c.options.noneResultsText.replace("{0}", '"' + i(c.$searchbox.val()) + '"')),
